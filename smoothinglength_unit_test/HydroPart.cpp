...
double tests::swift2::testSML1D::globaldata::HydroPart::_etaFactor
  = 2.5819884616099626;
...
tests::swift2::testSML1D::globaldata::HydroPart::HydroPart(
  ...
  double                                __v_sig_AV,
  double                                __soundSpeed,
  DependencyChecksPeanoEventUsedBySwift __dependencyChecksPeanoEventUsedBySwift,
...
#if PeanoDebug > 0
  setDependencyChecksPeanoEventUsedBySwift(
    __dependencyChecksPeanoEventUsedBySwift
  );
#endif
#if PeanoDebug > 0
  setDependencyChecksAlgorithmStepLastUpdated(
    __dependencyChecksAlgorithmStepLastUpdated
  );
#endif
#if PeanoDebug > 0
...
#endif
#if PeanoDebug > 0
  setDependencyChecksAlgorithmStepMaskOuts(
    __dependencyChecksAlgorithmStepMaskOuts
  );
#endif
#if PeanoDebug > 0
...
#if PeanoDebug > 0
  setDependencyChecksPeanoEventUsedBySwift(
    copy.getDependencyChecksPeanoEventUsedBySwift()
  );
#endif
#if PeanoDebug > 0
  setDependencyChecksAlgorithmStepLastUpdated(
    copy.getDependencyChecksAlgorithmStepLastUpdated()
  );
#endif
#if PeanoDebug > 0
  setDependencyChecksAlgorithmStepUpdates(
    copy.getDependencyChecksAlgorithmStepUpdates()
  );
#endif
#if PeanoDebug > 0
  setDependencyChecksAlgorithmStepMaskOuts(
    copy.getDependencyChecksAlgorithmStepMaskOuts()
  );
#endif
#if PeanoDebug > 0
  setDependencyChecksInitStepLastUpdated(
    copy.getDependencyChecksInitStepLastUpdated()
  );
#endif
#if PeanoDebug > 0
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString() const {
  ...
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksPeanoEventUsedBySwift=" <<
  //   toString(_dependencyChecksPeanoEventUsedBySwift);
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksAlgorithmStepLastUpdated=" <<
  //   toString(_dependencyChecksAlgorithmStepLastUpdated);
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksAlgorithmStepUpdates=" <<
  //   _dependencyChecksAlgorithmStepUpdates[0] << ",...";
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksAlgorithmStepMaskOuts=" <<
  //   _dependencyChecksAlgorithmStepMaskOuts[0] << ",...";
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksInitStepLastUpdated=" <<
  //   toString(_dependencyChecksInitStepLastUpdated);
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksInitStepUpdates=" <<
  //   _dependencyChecksInitStepUpdates[0] << ",...";
  // #endif
  // #if PeanoDebug > 0
  //   out << ",";
  //   out << "dependencyChecksInitStepMaskOuts=" <<
  //   _dependencyChecksInitStepMaskOuts[0] << ",...";
  // #endif
  out << ")";
  return out.str();
}
...
#if PeanoDebug > 0
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getDebugX() const {
  return _debugX;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setDebugX(
...
double tests::swift2::testSML1D::globaldata::HydroPart::getDebugX(int index
) const {
...
#if PeanoDebug > 0
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getDebugH() const {
  return _debugH;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setDebugH(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _debugH = value;
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getDebugH(int index
) const {
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getX() const {
  return _x;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setX(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _x = value;
}
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getCellH() const {
  return _cellH;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setCellH(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _cellH = value;
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getCellH(int index
) const {
  return _cellH(index);
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getSearchRadius(
) const {
  return _searchRadius;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setSearchRadius(
  double value
) {
  _searchRadius = value;
}
...
tests::swift2::testSML1D::globaldata::HydroPart::ParallelState tests::swift2::
  testSML1D::globaldata::HydroPart::getParallelState() const {
  return _ParallelState;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setParallelState(
  ParallelState value
) {
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString(
  ParallelState value
) {
  std::ostringstream out;
  out << (value == ParallelState::Local ? "Local" : "")
      << (value == ParallelState::Virtual ? "Virtual" : "");
  return out.str();
}


tests::swift2::testSML1D::globaldata::HydroPart::MoveState tests::swift2::
  testSML1D::globaldata::HydroPart::getMoveState() const {
  return _MoveState;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setMoveState(
  MoveState value
) {
  _MoveState = value;
}
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString(
  ...
  std::ostringstream out;
  out
    << (value == MoveState::New ? "New" : "")
    << (value == MoveState::NotMovedYet ? "NotMovedYet" : "")
    << (value == MoveState::Moved ? "Moved" : "");
  return out.str();
}


bool tests::swift2::testSML1D::globaldata::HydroPart::getCellHasUpdatedParticle(
) const {
  return _CellHasUpdatedParticle;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setCellHasUpdatedParticle(
  bool value
) {
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getV() const {
  return _v;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setV(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _v = value;
}
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getA() const {
  return _a;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setA(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _a = value;
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getSmoothingLength(
) const {
  return _smoothingLength;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setSmoothingLength(
  double value
) {
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getV_full() const {
  return _v_full;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setV_full(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _v_full = value;
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getV_full(int index
) const {
...
int tests::swift2::testSML1D::globaldata::HydroPart::
  getSmoothingLengthIterCount() const {
  return _smoothingLengthIterCount;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setSmoothingLengthIterCount(int value) {
  _smoothingLengthIterCount = value;
}


double tests::swift2::testSML1D::globaldata::HydroPart::getSmlIterLeftBound(
) const {
  return _smlIterLeftBound;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setSmlIterLeftBound(
  double value
) {
...
double tests::swift2::testSML1D::globaldata::HydroPart::getSmlIterRightBound(
) const {
  return _smlIterRightBound;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setSmlIterRightBound(
  double value
) {
...
bool tests::swift2::testSML1D::globaldata::HydroPart::getHasNoNeighbours(
) const {
  return _hasNoNeighbours;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setHasNoNeighbours(
  bool value
) {
...
bool tests::swift2::testSML1D::globaldata::HydroPart::
  getSmoothingLengthConverged() const {
  return _smoothingLengthConverged;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setSmoothingLengthConverged(bool value) {
  _smoothingLengthConverged = value;
}


#if PeanoDebug > 0
int tests::swift2::testSML1D::globaldata::HydroPart::getDensityNeighbourCount(
) const {
  return _densityNeighbourCount;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setDensityNeighbourCount(
  int value
) {
...
#if PeanoDebug > 0
int tests::swift2::testSML1D::globaldata::HydroPart::getForceNeighbourCount(
) const {
  return _forceNeighbourCount;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setForceNeighbourCount(
  int value
) {
...
tarch::la::Vector<Dimensions, double> tests::swift2::testSML1D::globaldata::
  HydroPart::getRot_v() const {
  return _rot_v;
}


void tests::swift2::testSML1D::globaldata::HydroPart::setRot_v(
  const tarch::la::Vector<Dimensions, double>& value
) {
  _rot_v = value;
}
...
double tests::swift2::testSML1D::globaldata::HydroPart::getRot_v(int index
) const {
  return _rot_v(index);
}
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString(
  ...
  std::ostringstream out;
  out
    << (value == DependencyChecksPeanoEventUsedBySwift::touchVertexFirstTime
          ? "touchVertexFirstTime"
          : "")
    << (value == DependencyChecksPeanoEventUsedBySwift::cellKernel
          ? "cellKernel"
          : "")
    << (value == DependencyChecksPeanoEventUsedBySwift::touchVertexLastTime
          ? "touchVertexLastTime"
          : "")
    << (value == DependencyChecksPeanoEventUsedBySwift::count ? "count" : "");
  return out.str();
}
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString(
  ...
  std::ostringstream out;
  out
    << (value == DependencyChecksAlgorithmStepLastUpdated::SPH_Drift
          ? "SPH_Drift"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::PredictHydro
          ? "PredictHydro"
          : "")
    << (value
            == DependencyChecksAlgorithmStepLastUpdated::
              SPH_DensityLoopWithConstantSearchRadius
          ? "SPH_DensityLoopWithConstantSearchRadius"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::SPH_ForceLoop
          ? "SPH_ForceLoop"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::SPH_Kick2
          ? "SPH_Kick2"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::SPH_Timestep
          ? "SPH_Timestep"
          : "")
    << (value
            == DependencyChecksAlgorithmStepLastUpdated::
              SPH_ReduceGlobalQuantities
          ? "SPH_ReduceGlobalQuantities"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::SPH_Kick1
          ? "SPH_Kick1"
          : "")
    << (value == DependencyChecksAlgorithmStepLastUpdated::count ? "count" : ""
       );
  return out.str();
}
...
#if PeanoDebug > 0
const int* tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksAlgorithmStepUpdates() const {
  return _dependencyChecksAlgorithmStepUpdates;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksAlgorithmStepUpdates(const int value[24]) {
  std::copy_n(value, 24, _dependencyChecksAlgorithmStepUpdates);
}


int tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksAlgorithmStepUpdates(int index) const {
  return _dependencyChecksAlgorithmStepUpdates[index];
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksAlgorithmStepUpdates(int index, int value) {
...
#if PeanoDebug > 0
const int* tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksAlgorithmStepMaskOuts() const {
  return _dependencyChecksAlgorithmStepMaskOuts;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksAlgorithmStepMaskOuts(const int value[24]) {
  std::copy_n(value, 24, _dependencyChecksAlgorithmStepMaskOuts);
}


int tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksAlgorithmStepMaskOuts(int index) const {
  return _dependencyChecksAlgorithmStepMaskOuts[index];
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksAlgorithmStepMaskOuts(int index, int value) {
...
std::string tests::swift2::testSML1D::globaldata::HydroPart::toString(
  ...
  std::ostringstream out;
  out
    << (value == DependencyChecksInitStepLastUpdated::SPH_FirstInitParticle
          ? "SPH_FirstInitParticle"
          : "")
    << (value
            == DependencyChecksInitStepLastUpdated::
              SPH_DensityLoopWithConstantSearchRadius
          ? "SPH_DensityLoopWithConstantSearchRadius"
          : "")
    << (value == DependencyChecksInitStepLastUpdated::SPH_ForceLoop
          ? "SPH_ForceLoop"
          : "")
    << (value == DependencyChecksInitStepLastUpdated::SPH_Timestep
          ? "SPH_Timestep"
          : "")
...
#if PeanoDebug > 0
const int* tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksInitStepUpdates() const {
  return _dependencyChecksInitStepUpdates;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksInitStepUpdates(const int value[12]) {
  std::copy_n(value, 12, _dependencyChecksInitStepUpdates);
}


int tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksInitStepUpdates(int index) const {
  return _dependencyChecksInitStepUpdates[index];
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksInitStepUpdates(int index, int value) {
...
#if PeanoDebug > 0
const int* tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksInitStepMaskOuts() const {
  return _dependencyChecksInitStepMaskOuts;
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksInitStepMaskOuts(const int value[12]) {
  std::copy_n(value, 12, _dependencyChecksInitStepMaskOuts);
}


int tests::swift2::testSML1D::globaldata::HydroPart::
  getDependencyChecksInitStepMaskOuts(int index) const {
  return _dependencyChecksInitStepMaskOuts[index];
}


void tests::swift2::testSML1D::globaldata::HydroPart::
  setDependencyChecksInitStepMaskOuts(int index, int value) {
...
MPI_Datatype tests::swift2::testSML1D::globaldata::HydroPart::Datatype
  = MPI_DATATYPE_NULL;
#endif


[[clang::map_mpi_datatype]] MPI_Datatype tests::swift2::testSML1D::globaldata::
  HydroPart::getForkDatatype() {
  return Datatype;
}


[[clang::map_mpi_datatype]] MPI_Datatype tests::swift2::testSML1D::globaldata::
  HydroPart::getGlobalCommunciationDatatype() {
  return Datatype;
}


[[clang::map_mpi_datatype]] MPI_Datatype tests::swift2::testSML1D::globaldata::
  HydroPart::getJoinDatatype() {
  return Datatype;
}


[[clang::map_mpi_datatype]] MPI_Datatype tests::swift2::testSML1D::globaldata::
  HydroPart::getBoundaryExchangeDatatype() {
  return Datatype;
}


[[clang::map_mpi_datatype]] MPI_Datatype tests::swift2::testSML1D::globaldata::
  HydroPart::getMultiscaleDataExchangeDatatype() {
  return Datatype;
}


[[clang::map_mpi_datatype]] void tests::swift2::testSML1D::globaldata::
  HydroPart::freeForkDatatype() {
...
[[clang::map_mpi_datatype]] void tests::swift2::testSML1D::globaldata::
  HydroPart::freeGlobalCommunciationDatatype() {
  if (Datatype != MPI_DATATYPE_NULL) {
    MPI_Type_free(&Datatype);
    Datatype = MPI_DATATYPE_NULL;
  }
...
[[clang::map_mpi_datatype]] void tests::swift2::testSML1D::globaldata::
  HydroPart::freeBoundaryExchangeDatatype() {
  if (Datatype != MPI_DATATYPE_NULL) {
    MPI_Type_free(&Datatype);
    Datatype = MPI_DATATYPE_NULL;
  }
...
[[clang::map_mpi_datatype]] void tests::swift2::testSML1D::globaldata::
  HydroPart::freeMultiscaleDataExchangeDatatype() {
  if (Datatype != MPI_DATATYPE_NULL) {
    MPI_Type_free(&Datatype);
    Datatype = MPI_DATATYPE_NULL;
  }
...
void tests::swift2::testSML1D::globaldata::HydroPart::initDatatype() {
  ...
  counter++;
  MPI_Get_address(
    &(instances[0]._smoothingLengthConverged = false),
    &disp[counter]
  );
  counter++;
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksPeanoEventUsedBySwift),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksAlgorithmStepLastUpdated),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksAlgorithmStepUpdates[0]),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksAlgorithmStepMaskOuts[0]),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksInitStepLastUpdated),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksInitStepUpdates[0]),
    &disp[counter]
  );
  counter++;
#endif
...
#if PeanoDebug > 0
  MPI_Get_address(
    &(instances[0]._dependencyChecksInitStepMaskOuts[0]),
    &disp[counter]
  );
  counter++;
#endif
  ...
  errorCode += MPI_Type_create_struct(
    NumberOfAttributes,
    blocklen,
    disp,
    subtypes,
  ...
  if (errorCode)
    std::cerr
      << "error constructing MPI datatype in " << __FILE__ << ":" << __LINE__
      << std::endl;
...
::swift2::ParticleSpecies& tests::swift2::testSML1D::globaldata::HydroPart::
  getSpecies() {
